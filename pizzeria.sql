...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`producte` (
  ...
  INDEX `fk_producte_categoria_pizza1_idx` (`categoria_pizza_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `Pizzeria`.`comanda_productes` (
  ...
  INDEX `fk_comanda_productes_client1_idx` (`client_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_comanda_productes_producte1`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_comanda_productes_categoria_producte1`
    FOREIGN KEY (`categoria_producte_id`)
    REFERENCES `Pizzeria`.`categoria_producte` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_comanda_productes_client1`
    FOREIGN KEY (`client_id`)
    REFERENCES `Pizzeria`.`client` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
INSERT INTO comanda (data_comanda,entrega,total_productes,preu_total,lliurament,empleat_id,client_id,botiga_id) VALUES
('2022-10-01','domilici',2,15.00,'2022-10-01 21:15:34',1,3,1),
('2022-02-11','recollir',3,16.99,NULL,NULL,1,1),
('2021-06-13','recullir',1,5.99,NULL,NULL,5,2),
('2022-01-01','domicili',2,13.99,'2022-01-01 20:12:45',2,3,2),
('2022-01-11','domicili',2,16.99,'2022-01-11 21:52:45',2,1,2),
('2022-03-30','domicili',3,11.99,'2022-03-30 21:00:00',2,1,1);

INSERT INTO comanda_productes(comanda_id,producte_id,categoria_producte_id,client_id) VALUES
(1,2,2,3),
(1,3,1,3),
(2,4,3,1),
(2,2,2,1),
...
/*SELECT count(cp.producte_id) FROM comanda_productes AS cp INNER JOIN client AS c ON c.id = cp.client_id AND c.localitat = 'Badalona' WHERE cp.categoria_producte_id = 1;*/
